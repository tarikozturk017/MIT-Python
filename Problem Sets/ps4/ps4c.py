    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for letter in string.ascii_lowercase:
            if letter in VOWELS_LOWER:
                vowel_index = VOWELS_LOWER.find(letter)
                mapping[letter] = vowels_permutation[vowel_index]
                mapping[str.upper(letter)] = str.upper(vowels_permutation[vowel_index])
            else:
                mapping[letter] = letter
                mapping[str.upper(letter)] = str.upper(letter)
        return mapping
